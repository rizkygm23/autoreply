...
Current Mode: quote_tweet

Task:
Write a quote retweet comment that appears above the quoted tweet.
Follow LENGTH CONTROL rules (Default max 2 sentences, but up to 5 only if analyzing deep tech/FDV).
No lists (except if deep tech explanation requires flow, but user says "No bullet points" in rule 3).
